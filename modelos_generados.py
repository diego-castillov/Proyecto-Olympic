...
class DetallePedido(models.Model):
    ...
    id_pedido = models.ForeignKey('Pedido', models.DO_NOTHING, db_column='ID_Pedido')  # Field name made lowercase.
    id_producto = models.ForeignKey('Producto', models.DO_NOTHING, db_column='ID_Producto')  # Field name made lowercase.
    id_talla = models.ForeignKey('Talla', models.DO_NOTHING, db_column='ID_Talla')  # Field name made lowercase.
